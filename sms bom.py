# note : some codes are collected from SHIMANTO
...
\033[1;92m[+] AUTHOR       :   XAIKO-SHIMANTO👿 
\x1b[1;92m[+] FACEBOOK     :   SHIMANTO CHOWDHURY 
\x1b[1;92m[+] GITHUB       :   SHIMANTO-404-CYBER
\x1b[1;12m[+] TEAM         :   \33[1;42  SH1MANTO\33[0m
\033[1;92m[+] TOOLS        :   SMS BOMBER SHIMANTO
...
for i in range(amo):
        ...
        print(f"\n\t\t {ran2}SHIMANTO SMS SENT SHIMANTO âž” "+w+tim)
        ...
        print(c+"\n\n\n\t\t[SHIMANTO] THANKS FOR USING THIS TOOL [SHIMANTO]")
        input(g+"\n\t\t\tEnter For Continue")
        os.system("clear")
